...
nearest preceding HTML comment of the form <!-- lint: cookbook -->,
<!-- lint: snippet -->, or <!-- lint: publisher -->, searching upward past
blank lines only. Anything else is 'unmarked'.
"""
import os
import pathlib
import re
...
def cmd_cookbook():
    ...
    for kind, language, line, body in blocks():
        if kind != "cookbook" or language != "bash":
            continue
        found += 1
