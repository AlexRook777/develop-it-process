...
CHECKS = [
    ...
    ("spec-reviewer-codex", r"findings\.jsonl", "canonical JSONL findings format"),
    ("plan-reviewer-codex", r"findings\.jsonl", "canonical JSONL findings format"),
    ("code-reviewer-codex", r"findings\.jsonl", "canonical JSONL findings format"),
    ...
    ("spec-fixer", r"record_finding_disposition", "bounded per-finding disposition call"),
