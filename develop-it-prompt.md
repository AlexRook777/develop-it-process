...
# role-contract registry, policy registry, event-contract registry, and
# publisher program -- an all-or-nothing operation. Sets (non-local, for the
...
# The five generated-file names, in the fixed order they are extracted and
...
# lists EXACTLY the five generated-file entries (never fewer, never extra),
...
# Extracts all five generated files into $1 (a fresh, empty staging
