...
### Step 7.1 — Iteration loop (same convergence procedure as Step 3.1, `phases/3-spec-review.md`; the bounded fixer is `implementation-fixer`, NOT the full `implementer` — Phase 6's role never re-runs the plan's task loop for a review finding)
